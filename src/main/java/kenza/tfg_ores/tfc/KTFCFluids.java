...
//     * Fluid instances
//     */
//    public static final Map<KMetal.Default, FluidRegistryObject<ForgeFlowingFluid>> METALS = Helpers.mapOfKeys(KMetal.Default.class, metal -> register(
//        "metal/" + metal.getSerializedName(),
//        properties -> properties
//            .block(KTFCBlocks.METAL_FLUIDS.get(metal))
//            .bucket(KTFCItems.FLUID_BUCKETS.get(KFluidId.asType(metal)))
